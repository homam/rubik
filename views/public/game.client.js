...
var game_type = {
    ...
    _getAdjacentSquares: function (i, j, dir) {
        ...
        return _q.filter(_q.map(line.getAdjacentSquarePositions(), function (pos) {
            return self.squares[pos.i] && self.squares[pos.j] ? self.squares[pos.i][pos.j] : null;
    ...
    events: {
        ...
        tookASquare: function (square) { }
    }
};

var makeGame = function (maxi, maxj, player1, player2) {
                ...
                for (var i = 0; i <= maxi; i++) {
                    ...
                    for (var j = 0; j <= maxj; j++) {
                        ...
                        ['H', 'V'].forEach(function (dir) {
                            ...
                            var line = Object.create(line_type, {
                                ...
                                'owner': { value: null, enumerable: true, writable: true }
                            });
        ...
        'squares': {
            value: (function () {
                ...
                for (var i = 0; i < maxi; i++) {
                    squares[i] = [];
                    for (var j = 0; j < maxj; j++) {
                        squares[i][j] = Object.create(square_type, {
                            'i': { value: i, enumerable: true, writable: false },
                            'j': { value: j, enumerable: true, writable: false }
                        });
                    }
